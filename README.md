# Diaxel — AI‑ассистенты для автоматизации общения и поддержки
...
- ✅ Фронтенд: адаптивный дизайн, графики (Chart.js), демо‑аналитика.
- ✅ Proto: схема для gRPC, скрипты генерации.
- ✅ Go‑сервисы: базовые модели, репозитории, grpc‑сервер.
- ✅ Docker‑композиция.
