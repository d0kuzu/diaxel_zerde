...
var Tools = []openai.Tool{
	...
	},
	{
		...
		Function: &openai.FunctionDefinition{
			Name:        "create_booking",
			Description: "Create a booking appointment at a specific time slot. Call this only after the user has selected an available time slot and provided their name and email address.",
			Parameters: map[string]interface{}{
				"type": "object",
				"properties": map[string]interface{}{
