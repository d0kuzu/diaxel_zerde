...
const file_proto_database_proto_rawDesc = "" +
	...
	"\x11UpsertCampuslogin\x12\".database.UpsertCampusloginRequest\x1a#.database.UpsertCampusloginResponseB+Z)diaxel_zerde/database-service/proto;protob\x06proto3"
...
var file_proto_database_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_proto_database_proto_goTypes = []any{
	...
	(*CampusloginRequest)(nil),               // 54: database.CampusloginRequest
	(*UpsertCampusloginRequest)(nil),         // 55: database.UpsertCampusloginRequest
	(*CampusloginResponse)(nil),              // 56: database.CampusloginResponse
	(*UpsertCampusloginResponse)(nil),        // 57: database.UpsertCampusloginResponse
}
var file_proto_database_proto_depIdxs = []int32{
	...
	54, // 39: database.DatabaseService.GetCampusloginByUserId:input_type -> database.CampusloginRequest
	55, // 40: database.DatabaseService.UpsertCampuslogin:input_type -> database.UpsertCampusloginRequest
	...
	56, // 76: database.DatabaseService.GetCampusloginByUserId:output_type -> database.CampusloginResponse
	57, // 77: database.DatabaseService.UpsertCampuslogin:output_type -> database.UpsertCampusloginResponse
