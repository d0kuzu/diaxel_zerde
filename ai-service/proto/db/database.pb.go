...
func (x *UpsertCampusloginRequest) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *DailyCount) Reset() {
	*x = DailyCount{}
	mi := &file_proto_db_database_proto_msgTypes[71]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DailyCount) Descriptor() ([]byte, []int) {
	return file_proto_db_database_proto_rawDescGZIP(), []int{71}
}
...
type GetWeeklyChatsStartedRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssistantId   string                 `protobuf:"bytes,1,opt,name=assistant_id,json=assistantId,proto3" json:"assistant_id,omitempty"`
	StartTime     string                 `protobuf:"bytes,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
...
func (x *GetWeeklyChatsStartedRequest) Reset() {
	*x = GetWeeklyChatsStartedRequest{}
	mi := &file_proto_db_database_proto_msgTypes[72]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWeeklyChatsStartedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*GetWeeklyChatsStartedRequest) Descriptor() ([]byte, []int) {
	return file_proto_db_database_proto_rawDescGZIP(), []int{72}
}
...
type GetWeeklyChatsStartedResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Days          []*DailyCount          `protobuf:"bytes,1,rep,name=days,proto3" json:"days,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetWeeklyChatsStartedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type IsCustomerBlockedRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *IsCustomerBlockedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type IsCustomerBlockedResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *IsCustomerBlockedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_proto_db_database_proto_rawDesc = "" +
	...
	"\x04days\x18\x01 \x03(\v2\x14.database.DailyCountR\x04days\"3\n" +
	"\x18IsCustomerBlockedRequest\x12\x17\n" +
	...
	"\x11IsCustomerBlocked\x12\".database.IsCustomerBlockedRequest\x1a#.database.IsCustomerBlockedResponseB+Z)diaxel_zerde/database-service/proto;protob\x06proto3"
...
var file_proto_db_database_proto_msgTypes = make([]protoimpl.MessageInfo, 76)
...
var file_proto_db_database_proto_depIdxs = []int32{
	...
	59, // 44: database.DatabaseService.SetCampusloginFlags:input_type -> database.SetCampusloginFlagsRequest
